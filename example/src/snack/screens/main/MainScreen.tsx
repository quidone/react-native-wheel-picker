...
const screens: {title: string; screenName: string}[] = [
  {screenName: 'SimplePicker', title: 'Simple Picker'},
  {
    screenName: 'SimplePickerAndIOSPicker',
    title: 'Simple Picker and iOS Picker',
  },
  {
    ...
    <>
      {screens.map((screen) => (
        <React.Fragment key={screen.screenName}>
          <ListItem onPress={() => navigation.navigate(screen.screenName)}>
            <ListItem.Content>
